			...
			<div class="col-md-12 column">
				<div class="page-header">
					<h1 class="text-danger">
						Carnegie Financial Services <small>
							<!-- Ready to get started? --> <!--  <button type="button" class="btn btn-sm btn-danger">Sign Up an Account</button>  -->
				...
				Welcome, ${employee.firstname}   ${employee.lastname}
						...
						class="btn btn-success">Sign in</button> -->
							...
							</div> <!-- <div class="modal fade" id="modal-container-353912" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="display: none;">
				...
				<div class="modal-footer">
					...
					<small>CFS serves the best service for you</small> Or give us a
					call at (412)888-8888.
				</div>
			</div>
		</div>
		<div class="row clearfix">
					...
					<c:choose>
							...
							<div class="panel panel-default">
								<div class="panel-heading">
									<a class="panel-title" data-toggle="collapse"
										data-parent="#panel-872653" href="#panel-element-236921">My
										Account</a>
								</div>
								...
								<div class="panel-heading">
									<a class="panel-title" data-toggle="collapse"
										data-parent="#panel-872653" href="#panel-element-236921">Financial
										Operation</a>
								</div>
								<div id="panel-element-236921" class="panel-collapse">
									<div class="panel-body">
						...
						<c:when test="${not empty employee}">
							<div class="panel panel-default">
								...
								<div class="panel-heading">
									<a class="panel-title" data-toggle="collapse"
										data-parent="#panel-872653" href="#panel-element-236922">Account
										Operation</a>
								</div>
								...
								<div class="panel-heading">
									<a class="panel-title" data-toggle="collapse"
										data-parent="#panel-872653" href="#panel-element-236923">My
										Account</a>
								</div>
